...
namespace LuminaryFramework.LuminaryBase.Efectos
{
    public class ModeloAnimadoEfectos
    {
        ...
        // Effect file name
        public static string EFFECT_FILE_NAME = "Efectos/AnimatedModel";
        ...
        #region Properties
        public ModeloAnimadoEfectos.Techniques CurrentTechnique
        {
            set
            {
        ...
        public ModeloAnimadoEfectos(Effect effect)
        {
            this.effect = effect;
            GetEffectParameters();
        }
