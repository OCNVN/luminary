...
namespace Aprendiendo.luminary.chat
{
    ...
    /// <summary>
    /// Para especificar si toda la pantalla modal se muestra en funcion de si
    /// esta conectado o no el administrador
    /// </summary>
    public class AdministradorEstaConectadoModalConverter : System.Windows.Data.IValueConverter
    {
            ...
            object parameter, System.Globalization.CultureInfo culture)
        {
            if (value != null)
            {
                Boolean estaConectado = System.Convert.ToBoolean(value.ToString());
                if (estaConectado)
                    return "Hidden";
                else
                    return "Visible";
    ...
    public class AdministradorEstaConectadoEfectoBlurConverter : System.Windows.Data.IValueConverter
    {
        public object Convert(object value, Type targetType,
            object parameter, System.Globalization.CultureInfo culture)
        {
